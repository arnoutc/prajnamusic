...
const LaunchRequestHandler = {
  ...
  async handle(handlerInput) {
    ...
    if (!playbackInfo.hasPreviousPlaybackSession) {
      message = 'Welcome to Prajna Music. you can ask to play the audio to begin the playlist.';
      ...
      case 'PlaybackNearlyFinished':
        {
          ...
          const playlist = constants.audioData[playbackInfo.playOrder[enqueueIndex]];
...
const HelpHandler = {
  ...
  async handle(handlerInput) {
    ...
    if (!playbackInfo.hasPreviousPlaybackSession) {
      message = 'Welcome to Prajna Music. For instance you can say play the audio to begin the playlist, you can say next, say previous, or say shuffle.';
      ...
      message = 'You are listening to Prajna Music. You can say, Next or Previous to navigate through the playlist. At any time, you can say Pause to pause the audio and Resume to resume.';
    }
...
const controller = {
  async play(handlerInput) {
    ...
    const playlist = constants.audioData[playOrder[index]];
    const token = playOrder[index];
    playbackInfo.nextStreamEnqueued = true;

    responseBuilder
      .speak(`This is ${playlist.title}`)
      .withShouldEndSession(true)
      .addAudioPlayerPlayDirective(playBehavior, playlist.url, token, offsetInMilliseconds, null);
